...
class ProfileUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        if ($this->has('kartuKeluargaData')) {
            $rules['kartuKeluargaData.no_kk'] = ['required', 'string', 'max:16'];
        ...
        if ($this->has('rumahData')) {
            $rules['rumahData.perumahan'] = ['required', 'string', 'max:255'];
            $rules['rumahData.jalan'] = ['required', 'string', 'max:255'];
            $rules['rumahData.blok'] = ['required', 'string', 'max:10'];
            $rules['rumahData.nomor'] = ['required', 'string', 'max:10'];
        }
