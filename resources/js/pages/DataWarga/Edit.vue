...
const form = useForm({
  ...
  husband_name: props.warga.husband_name ?? '',
  ...
  <div class="max-w-4xl mx-auto p-4">
    ...
    <form @submit.prevent="submit" enctype="multipart/form-data" class="space-y-4">
      ...
      <div>
        ...
        <input v-model="form.husband_name" type="text" class="border rounded w-full p-1" />
      </div>
      ...
      <div>
        ...
        <div v-for="(child, index) in form.children_data" :key="index" class="mt-2 space-y-1 border p-2 rounded">
      ...
      <div>
        ...
        <div v-if="props.warga.document_path" class="mt-2">
          <a :href="props.warga.document_path" target="_blank" class="text-blue-600 underline">Lihat Dokumen Lama</a>
        </div>
      </div>
