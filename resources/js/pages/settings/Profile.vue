...
watch(
    ...
    (newWargaData) => {
        if (newWargaData) {
            form.wargaData.nik = newWargaData.nik || form.wargaData.nik;
            form.wargaData.full_name = newWargaData.full_name || form.wargaData.full_name;
            form.wargaData.tempat_lahir = newWargaData.tempat_lahir || form.wargaData.tempat_lahir;
            form.wargaData.tanggal_lahir = newWargaData.tanggal_lahir || form.wargaData.tanggal_lahir;
            // Only update status if it's actually provided and not empty
            if (newWargaData.status) {
                form.wargaData.status = newWargaData.status;
            }
        }
    },
...
watch(
    () => props.kartuKeluargaData,
    (newKartuKeluargaData) => {
        if (newKartuKeluargaData) {
            form.kartuKeluargaData.no_kk = newKartuKeluargaData.no_kk || form.kartuKeluargaData.no_kk;
            form.kartuKeluargaData.jumlah_anggota = newKartuKeluargaData.jumlah_anggota || form.kartuKeluargaData.jumlah_anggota;
            if (newKartuKeluargaData.foto_ktp_kepala_keluarga) {
                imagePreview.value = newKartuKeluargaData.foto_ktp_kepala_keluarga;
            }
        }
    },
    { immediate: true, deep: true },
...
watch(
    ...
    (newRumahData) => {
        if (newRumahData) {
            form.rumahData.id_rumah = newRumahData.id_rumah || form.rumahData.id_rumah;
            form.rumahData.perumahan = newRumahData.perumahan || form.rumahData.perumahan;
            form.rumahData.jalan = newRumahData.jalan || form.rumahData.jalan;
            form.rumahData.blok = newRumahData.blok || form.rumahData.blok;
            form.rumahData.nomor = newRumahData.nomor || form.rumahData.nomor;
        }
    },
    { immediate: true, deep: true },
);
...
const submit = () => {
    ...
    // Always include wargaData to allow partial updates
    dataToSend.wargaData = form.wargaData;

    // Include kartuKeluargaData if user is warga and status is Kepala Keluarga
    if (user.roles?.some((role: any) => role.name.toLowerCase() === 'warga') && form.wargaData.status?.toLowerCase() === 'kepala keluarga') {
        dataToSend.kartuKeluargaData = form.kartuKeluargaData;
    }

    // Include rumahData if user is warga and status is Kepala Keluarga
    if (user.roles?.some((role: any) => role.name.toLowerCase() === 'warga') && form.wargaData.status?.toLowerCase() === 'kepala keluarga') {
        ...
        <SettingsLayout>
            <div class="flex flex-col space-y-6">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div v-if="user.roles?.some((role: any) => role.name.toLowerCase() === 'warga')" class="space-y-6">
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input
                                id="full_name"
                                class="mt-1 block w-full"
                                v-model="form.wargaData.full_name"
                                required
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input
                                ...
                                type="date"
                                class="mt-1 block w-full"
                                v-model="form.wargaData.tanggal_lahir"
                    ...
                    <div
                        v-if="
                            user.roles?.some((role: any) => role.name.toLowerCase() === 'warga') &&
                            form.wargaData.status?.toLowerCase() === 'kepala keluarga'
                        "
                        class="space-y-6"
                    >
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input
                                id="no_kk"
                                class="mt-1 block w-full"
                                v-model="form.kartuKeluargaData.no_kk"
                                maxlength="16"
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input
                                ...
                                min="1"
                                class="mt-1 block w-full"
                                v-model="form.kartuKeluargaData.jumlah_anggota"
